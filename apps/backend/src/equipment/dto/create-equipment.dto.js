...
let CreateEquipmentInput = (() => {
    ...
    var CreateEquipmentInput = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _categoryId_decorators = [Field(), IsUUID()];
            _manufacturer_decorators = [Field(), IsString(), MaxLength(200)];
            _modelNumber_decorators = [Field(), IsString(), MaxLength(100)];
            _name_decorators = [Field(), IsString(), MaxLength(300)];
            ...
            _standardPrice_decorators = [Field(() => Float), IsNumber(), Min(0.01)];
            ...
            CreateEquipmentInput = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        categoryId = __runInitializers(this, _categoryId_initializers, void 0);
        ...
        specifications = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _specifications_initializers, void 0)); // JSON string, will be validated in service
    ...
    return CreateEquipmentInput = _classThis;
})();
export { CreateEquipmentInput };
let CreateVendorPricingInput = (() => {
    let _classDecorators = [InputType()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    ...
    var CreateVendorPricingInput = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _vendorName_decorators = [Field(), IsString(), MaxLength(200)];
            _specialPrice_decorators = [Field(() => Float), IsNumber(), Min(0.01)];
            ...
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CreateVendorPricingInput = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        vendorName = __runInitializers(this, _vendorName_initializers, void 0);
    ...
    return CreateVendorPricingInput = _classThis;
})();
export { CreateVendorPricingInput };
let CreateEquipmentWithPricingInput = (() => {
    let _classDecorators = [InputType()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = CreateEquipmentInput;
    let _vendorPricing_decorators;
    let _vendorPricing_initializers = [];
    let _vendorPricing_extraInitializers = [];
    var CreateEquipmentWithPricingInput = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _vendorPricing_decorators = [Field(() => [CreateVendorPricingInput], { nullable: true }), IsOptional()];
            ...
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CreateEquipmentWithPricingInput = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        vendorPricing = __runInitializers(this, _vendorPricing_initializers, void 0);
        constructor() {
            super(...arguments);
            __runInitializers(this, _vendorPricing_extraInitializers);
        }
    };
    return CreateEquipmentWithPricingInput = _classThis;
})();
export { CreateEquipmentWithPricingInput };
