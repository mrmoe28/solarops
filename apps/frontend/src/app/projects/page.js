      ...
      {projects.length === 0 ? (<Card className="text-center py-12">
          ...
          {projects.map((project) => (<Card key={project.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                ...
                {project.status === ProjectStatus.COMPLETED && (<div className="space-y-2">
                    {project.solarDesign && (<div className="flex items-center justify-between">
                    ...
                    {project.proposal && (<div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
