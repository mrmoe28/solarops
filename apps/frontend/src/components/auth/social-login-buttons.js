...
export function SocialLoginButtons({ onGoogleLogin, onGitHubLogin, loading = false, }) {
    return (<div className="space-y-2">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Button type="button" variant="outline" onClick={onGitHubLogin} disabled={loading || !onGitHubLogin} className="w-full">
